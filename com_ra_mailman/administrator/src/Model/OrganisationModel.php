...
class OrganisationModel extends AdminModel {
     ...
     * @since  3.0.0
     */
    public $typeAlias = 'com_ra_mailman.organisation';
     ...
     * @since   3.0.0
     */
    public function getTable($type = 'Organisation', $prefix = 'Administrator', $config = array()) {
    ...
    protected function loadFormData() {
        ...
        $data = Factory::getApplication()->getUserState('com_ra_mailman.edit.organisation.data', array());
